...
# >-------------------------- templates/recipe.erb ---------------------------start<
# >------------------------------[ mindpin-custom ]------------------------------<
@current_recipe = "mindpin-custom"
@before_configs["mindpin-custom"].call if @before_configs["mindpin-custom"]
say_recipe 'mindpin-custom'
@configs[@current_recipe] = config
# >------------------------- recipes/mindpin-custom.rb --------------------------start<

# Application template recipe for the rails_apps_composer. Change the recipe here:
# 暂时还没弄这个地址
# https://github.com/destinyd/rails_apps_composer/blob/master/recipes/mindpin-custom.rb

if prefer :apps4, 'mindpin-custom'
